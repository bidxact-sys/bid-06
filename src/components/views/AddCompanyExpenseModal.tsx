...
export function AddCompanyExpenseModal({ isOpen, onClose, onAdd }: Props) {
  const [form, setForm] = useState({ date: new Date().toISOString().slice(0, 10), vendor: '', description: '', category: 'Software & Technology', department: 'Services', project: '', amount: '', account: 'Operating Checking ••8491', taxTreatment: 'Business expense - deductible', approval: 'Pending Approval', paymentStatus: 'Unpaid' });
