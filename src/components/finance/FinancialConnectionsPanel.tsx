...
export const FinancialConnectionsPanel: React.FC = () => {
  ...
  const removeConnection = (index: number) => {
    ...
    if (!window.confirm(`Remove ${connection.provider} account connection?`)) return;
